...
Similar functionality is available in limnd2 CLI tool, but this example shows how to use
...
OUTPUT_FILE = TIFF_FOLDER / "output_tc.nd2"                          # output file name
...
pictureMetadata = metadata_factory.createMetadata()
