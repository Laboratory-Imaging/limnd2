...
An example Python file showcasing how to read an `.nd2` file with this library is found at GitHub repo for this page: [example_reader.py](https://github.com/Laboratory-Imaging/limnd2/examples/example_reader.py).
