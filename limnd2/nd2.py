...
class Nd2Reader:
    ...
    def crestDeepSimRawData(self, seqindex: int, componentindex: int) -> NumpyArrayLike:
        ...
        str
            A string representing the calibration key.
        str
            A string containing the XML data generated by the Crest deepSIM library.
        tuple[float, float]
            Point spread function values (used, default).
        tuple[int, int]
